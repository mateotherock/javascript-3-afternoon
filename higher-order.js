...
//Code Here
let totalPopulation = populations.reduce((runningTotal, population) => {
...
//Code Here
let myStrongest = monstersInYourPocket.filter((num) => num.CP>200)
...
let ordersTotal = orders.map((num) => "$" + num.price + num.tax)
console.log(ordersTotal)//Code Here
...
let bobsTotal = purchases.reduce((total, num) => {
  if (num.owner === "Bob") {
    total += num.price
  } return total
},0)
